...
debug "Generando archivo temporal"
echo "archivo temporal" > ${WD}/temporal

#asegurarse de eliminarlo al salir
function salir {
  debug "Se presiono CTRL+C, limpiando temporal..."
  rm ${WD}/temporal
  debug "Hasta luego...!"
}
