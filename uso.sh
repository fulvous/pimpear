...
#Imprimir como invocaron al script
echo $0

#imprimir solo el nombre del script
basename $0

#Guardar el nombre del script en una variable,
# evita errores cuando se cambie de nombre el script
NOMBRE=$( basename "$0" )

function uso {
  jumbotron "usage: ${NOMBRE} -h prints help"
}
